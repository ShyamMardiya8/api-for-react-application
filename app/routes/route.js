...
const { GET_USER_INFORMATION, POST_USER_INFORMATION, UPDATE_USER_INFORMATION, DELETE_USER_INFORMATION, HANDLE_SEARCH_HEADERS, GET_USER_INFORMATION_BY_ID } = require("../controllers/user")
...
route.get('/user/:id',verifyToken, appLimiter, GET_USER_INFORMATION_BY_ID)
